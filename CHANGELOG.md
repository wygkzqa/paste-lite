...
- **About page** — displays the app logo, version, build number, and GitHub link in a horizontally centered column starting below the page heading in Settings; the menu bar’s About Paste Lite opens the same page.
